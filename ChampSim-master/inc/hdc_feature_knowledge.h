#ifndef HDC_FEATURE_KNOWLEDGE
#define HDC_FEATURE_KNOWLEDGE
...
class FeatureKnowledge {
   ...
   public:
    ...
    inline void increase_weight() {
        m_weight = m_weight + m_weight_gradient * m_weight;
        if (m_weight < min_weight) min_weight = m_weight;
    }
    inline void decrease_weight() {
        m_weight = m_weight - m_weight_gradient * m_weight;
        if (m_weight > max_weight) max_weight = m_weight;
    }
