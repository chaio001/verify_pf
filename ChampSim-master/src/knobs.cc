...
/* hdcpf */
std::size_t hdcpf_hdc_dim = 2048;
std::size_t hdcpf_hdc_n_pc = 1024;
std::size_t hdcpf_hdc_n_delta = 128;
int hdcpf_hdc_max_weight = 7;
int hdcpf_hdc_min_weight = -8;

float hdcpf_threshold = 0.012114;
float hdcpf_update_threshold = 0.012114;
float hdcpf_alpha = 0.0065;
float hdcpf_gamma = 0.55;
float hdcpf_epsilon = 0.002;
uint32_t hdcpf_state_num_bits = 10;
uint32_t hdcpf_max_states = 1024;
uint32_t hdcpf_seed = 200;
string hdcpf_policy = std::string("EGreedy");
string hdcpf_learning_type = std::string("SARSA");
vector<int32_t> hdcpf_actions;
uint32_t hdcpf_max_actions = 64;
uint32_t hdcpf_pt_size = 256;
uint32_t hdcpf_st_size = 64;
int32_t hdcpf_reward_none = -4;
int32_t hdcpf_reward_incorrect = -8;
int32_t hdcpf_reward_correct_untimely = 12;
int32_t hdcpf_reward_correct_timely = 20;
uint32_t hdcpf_max_pcs = 5;
uint32_t hdcpf_max_offsets = 5;
uint32_t hdcpf_max_deltas = 5;
bool hdcpf_brain_zero_init = false;
bool hdcpf_enable_reward_all = false;
bool hdcpf_enable_track_multiple = false;
bool hdcpf_enable_reward_out_of_bounds = true;
int32_t hdcpf_reward_out_of_bounds = -12;
uint32_t hdcpf_state_type = 1;
bool hdcpf_access_debug = false;
bool hdcpf_print_access_debug = false;
uint64_t hdcpf_print_access_debug_pc = 0xdeadbeef;
uint32_t hdcpf_print_access_debug_pc_count = 0;
bool hdcpf_print_trace = false;
bool hdcpf_enable_state_action_stats = false;
bool hdcpf_enable_reward_tracker_hit = false;
int32_t hdcpf_reward_tracker_hit = -2;
bool hdcpf_enable_shaggy = false;
uint32_t hdcpf_state_hash_type = 11;
bool hdcpf_prefetch_with_shaggy = false;
bool hdcpf_enable_featurewise_engine = true;
uint32_t hdcpf_pref_degree = 1; /* default is set to 1 */
bool hdcpf_enable_dyn_degree = true;
vector<float> hdcpf_max_to_avg_q_thresholds; /* depricated */
vector<int32_t> hdcpf_dyn_degrees;
uint64_t hdcpf_early_exploration_window = 0;
uint32_t hdcpf_multi_deg_select_type = 2; /* type 1 is already depricated */
vector<int32_t> hdcpf_last_pref_offset_conf_thresholds;
vector<int32_t> hdcpf_dyn_degrees_type2;
uint32_t hdcpf_action_tracker_size = 2;
uint32_t hdcpf_high_bw_thresh = 4;
bool hdcpf_enable_hbw_reward = true;
int32_t hdcpf_reward_hbw_correct_timely = 20;
int32_t hdcpf_reward_hbw_correct_untimely = 12;
int32_t hdcpf_reward_hbw_incorrect = -14;
int32_t hdcpf_reward_hbw_none = -2;
int32_t hdcpf_reward_hbw_out_of_bounds = -12;
int32_t hdcpf_reward_hbw_tracker_hit = -2;
vector<int32_t> hdcpf_last_pref_offset_conf_thresholds_hbw;
vector<int32_t> hdcpf_dyn_degrees_type2_hbw;

int32_t hdcpf_reward_hbw_notsure = 0;
int32_t hdcpf_reward_notsure = 0;
...
/* Featurewise Learning Engine */
vector<int32_t> hdcpf_le_featurewise_active_features;
vector<int32_t> hdcpf_le_featurewise_num_tilings;
vector<int32_t> hdcpf_le_featurewise_num_tiles;
vector<int32_t> hdcpf_le_featurewise_hash_types;
vector<int32_t> hdcpf_le_featurewise_enable_tiling_offset;
float hdcpf_le_featurewise_max_q_thresh = 0.5;
bool hdcpf_le_featurewise_enable_action_fallback = true;
vector<float> hdcpf_le_featurewise_feature_weights;
bool hdcpf_le_featurewise_enable_dynamic_weight = false;
float hdcpf_le_featurewise_weight_gradient = 0.001;
bool hdcpf_le_featurewise_disable_adjust_weight_all_features_align = false;
bool hdcpf_le_featurewise_selective_update = false;
uint32_t hdcpf_le_featurewise_pooling_type = 2; /* max pooling */
bool hdcpf_le_featurewise_enable_dyn_action_fallback = true;
uint32_t hdcpf_le_featurewise_bw_acc_check_level = 1;
uint32_t hdcpf_le_featurewise_acc_thresh = 2;

bool hdcpf_le_featurewise_enable_trace = false;
uint32_t hdcpf_le_featurewise_trace_feature_type;
string hdcpf_le_featurewise_trace_feature;
uint32_t hdcpf_le_featurewise_trace_interval;
uint32_t hdcpf_le_featurewise_trace_record_count;
std::string hdcpf_le_featurewise_trace_file_name;
bool hdcpf_le_featurewise_enable_score_plot;
vector<int32_t> hdcpf_le_featurewise_plot_actions;
std::string hdcpf_le_featurewise_plot_file_name;
bool hdcpf_le_featurewise_remove_plot_script;
}  // namespace knob
...
int parse_knobs(void* user, const char* section, const char* name, const char* value) {
    ...
    else if (MATCH("", "hdcpf_hdc_dim")) {
        knob::hdcpf_hdc_dim = atof(value);
    } else if (MATCH("", "hdcpf_hdc_n_pc")) {
        knob::hdcpf_hdc_n_pc = atof(value);
    } else if (MATCH("", "hdcpf_hdc_n_delta")) {
        knob::hdcpf_hdc_n_delta = atof(value);
    } else if (MATCH("", "hdcpf_hdc_max_weight")) {
        knob::hdcpf_hdc_max_weight = atof(value);
    } else if (MATCH("", "hdcpf_hdc_min_weight")) {
        knob::hdcpf_hdc_min_weight = atof(value);
    }

    else if (MATCH("", "hdcpf_threshold")) {
        knob::hdcpf_threshold = atof(value);
    } else if (MATCH("", "hdcpf_update_threshold")) {
        knob::hdcpf_update_threshold = atof(value);
    } else if (MATCH("", "hdcpf_alpha")) {
        knob::hdcpf_alpha = atof(value);
    } else if (MATCH("", "hdcpf_gamma")) {
        knob::hdcpf_gamma = atof(value);
    } else if (MATCH("", "hdcpf_epsilon")) {
        knob::hdcpf_epsilon = atof(value);
    } else if (MATCH("", "hdcpf_state_num_bits")) {
        knob::hdcpf_state_num_bits = atoi(value);
        knob::hdcpf_max_states = pow(2.0, knob::hdcpf_state_num_bits);
    } else if (MATCH("", "hdcpf_seed")) {
        knob::hdcpf_seed = atoi(value);
    } else if (MATCH("", "hdcpf_policy")) {
        knob::hdcpf_policy = string(value);
    } else if (MATCH("", "hdcpf_learning_type")) {
        knob::hdcpf_learning_type = string(value);
    } else if (MATCH("", "hdcpf_actions")) {
        knob::hdcpf_actions = get_array_int(value);
        knob::hdcpf_max_actions = knob::hdcpf_actions.size();
    } else if (MATCH("", "hdcpf_pt_size")) {
        knob::hdcpf_pt_size = atoi(value);
    } else if (MATCH("", "hdcpf_st_size")) {
        knob::hdcpf_st_size = atoi(value);
    } else if (MATCH("", "hdcpf_reward_none")) {
        knob::hdcpf_reward_none = atoi(value);
    } else if (MATCH("", "hdcpf_reward_incorrect")) {
        knob::hdcpf_reward_incorrect = atoi(value);
    } else if (MATCH("", "hdcpf_reward_correct_untimely")) {
        knob::hdcpf_reward_correct_untimely = atoi(value);
    } else if (MATCH("", "hdcpf_reward_correct_timely")) {
        knob::hdcpf_reward_correct_timely = atoi(value);
    } else if (MATCH("", "hdcpf_max_pcs")) {
        knob::hdcpf_max_pcs = atoi(value);
    } else if (MATCH("", "hdcpf_max_offsets")) {
        knob::hdcpf_max_offsets = atoi(value);
    } else if (MATCH("", "hdcpf_max_deltas")) {
        knob::hdcpf_max_deltas = atoi(value);
    } else if (MATCH("", "hdcpf_brain_zero_init")) {
        knob::hdcpf_brain_zero_init = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_enable_reward_all")) {
        knob::hdcpf_enable_reward_all = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_enable_track_multiple")) {
        knob::hdcpf_enable_track_multiple = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_enable_reward_out_of_bounds")) {
        knob::hdcpf_enable_reward_out_of_bounds = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_reward_out_of_bounds")) {
        knob::hdcpf_reward_out_of_bounds = atoi(value);
    } else if (MATCH("", "hdcpf_state_type")) {
        knob::hdcpf_state_type = atoi(value);
    } else if (MATCH("", "hdcpf_access_debug")) {
        knob::hdcpf_access_debug = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_print_access_debug")) {
        knob::hdcpf_print_access_debug = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_print_access_debug_pc")) {
        knob::hdcpf_print_access_debug_pc = strtoul(value, NULL, 0);
    } else if (MATCH("", "hdcpf_print_access_debug_pc_count")) {
        knob::hdcpf_print_access_debug_pc_count = atoi(value);
    } else if (MATCH("", "hdcpf_print_trace")) {
        knob::hdcpf_print_trace = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_enable_state_action_stats")) {
        knob::hdcpf_enable_state_action_stats = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_enable_reward_tracker_hit")) {
        knob::hdcpf_enable_reward_tracker_hit = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_reward_tracker_hit")) {
        knob::hdcpf_reward_tracker_hit = atoi(value);
    } else if (MATCH("", "hdcpf_enable_shaggy")) {
        knob::hdcpf_enable_shaggy = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_state_hash_type")) {
        knob::hdcpf_state_hash_type = atoi(value);
    } else if (MATCH("", "hdcpf_prefetch_with_shaggy")) {
        knob::hdcpf_prefetch_with_shaggy = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_enable_featurewise_engine")) {
        knob::hdcpf_enable_featurewise_engine = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_pref_degree")) {
        knob::hdcpf_pref_degree = atoi(value);
    } else if (MATCH("", "hdcpf_enable_dyn_degree")) {
        knob::hdcpf_enable_dyn_degree = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_max_to_avg_q_thresholds")) {
        knob::hdcpf_max_to_avg_q_thresholds = get_array_float(value);
    } else if (MATCH("", "hdcpf_early_exploration_window")) {
        knob::hdcpf_early_exploration_window = atoi(value);
    } else if (MATCH("", "hdcpf_dyn_degrees")) {
        knob::hdcpf_dyn_degrees = get_array_int(value);
    } else if (MATCH("", "hdcpf_multi_deg_select_type")) {
        knob::hdcpf_multi_deg_select_type = atoi(value);
    } else if (MATCH("", "hdcpf_last_pref_offset_conf_thresholds")) {
        knob::hdcpf_last_pref_offset_conf_thresholds = get_array_int(value);
    } else if (MATCH("", "hdcpf_dyn_degrees_type2")) {
        knob::hdcpf_dyn_degrees_type2 = get_array_int(value);
    } else if (MATCH("", "hdcpf_action_tracker_size")) {
        knob::hdcpf_action_tracker_size = atoi(value);
    } else if (MATCH("", "hdcpf_high_bw_thresh")) {
        knob::hdcpf_high_bw_thresh = atoi(value);
    } else if (MATCH("", "hdcpf_enable_hbw_reward")) {
        knob::hdcpf_enable_hbw_reward = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_reward_hbw_correct_timely")) {
        knob::hdcpf_reward_hbw_correct_timely = atoi(value);
    } else if (MATCH("", "hdcpf_reward_hbw_correct_untimely")) {
        knob::hdcpf_reward_hbw_correct_untimely = atoi(value);
    } else if (MATCH("", "hdcpf_reward_hbw_incorrect")) {
        knob::hdcpf_reward_hbw_incorrect = atoi(value);
    } else if (MATCH("", "hdcpf_reward_hbw_none")) {
        knob::hdcpf_reward_hbw_none = atoi(value);
    } else if (MATCH("", "hdcpf_reward_hbw_out_of_bounds")) {
        knob::hdcpf_reward_hbw_out_of_bounds = atoi(value);
    } else if (MATCH("", "hdcpf_reward_hbw_tracker_hit")) {
        knob::hdcpf_reward_hbw_tracker_hit = atoi(value);
    } else if (MATCH("", "hdcpf_last_pref_offset_conf_thresholds_hbw")) {
        knob::hdcpf_last_pref_offset_conf_thresholds_hbw = get_array_int(value);
    } else if (MATCH("", "hdcpf_dyn_degrees_type2_hbw")) {
        knob::hdcpf_dyn_degrees_type2_hbw = get_array_int(value);
    } else if (MATCH("", "hdcpf_reward_hbw_notsure")) {
        knob::hdcpf_reward_hbw_notsure = atoi(value);
    } else if (MATCH("", "hdcpf_reward_notsure")) {
        knob::hdcpf_reward_notsure = atoi(value);
    }
    // /* Learning Engine */
    // else if (MATCH("", "le_enable_trace")) {
    //     knob::le_enable_trace = !strcmp(value, "true") ? true : false;
    ...
    /* Featurewise Learning Engine */
    else if (MATCH("", "hdcpf_le_featurewise_active_features")) {
        knob::hdcpf_le_featurewise_active_features = get_array_int(value);
    } else if (MATCH("", "hdcpf_le_featurewise_num_tilings")) {
        knob::hdcpf_le_featurewise_num_tilings = get_array_int(value);
    } else if (MATCH("", "hdcpf_le_featurewise_num_tiles")) {
        knob::hdcpf_le_featurewise_num_tiles = get_array_int(value);
    } else if (MATCH("", "hdcpf_le_featurewise_hash_types")) {
        knob::hdcpf_le_featurewise_hash_types = get_array_int(value);
    } else if (MATCH("", "hdcpf_le_featurewise_enable_tiling_offset")) {
        knob::hdcpf_le_featurewise_enable_tiling_offset = get_array_int(value);
    } else if (MATCH("", "hdcpf_le_featurewise_max_q_thresh")) {
        knob::hdcpf_le_featurewise_max_q_thresh = atof(value);
    } else if (MATCH("", "hdcpf_le_featurewise_enable_action_fallback")) {
        knob::hdcpf_le_featurewise_enable_action_fallback = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_feature_weights")) {
        knob::hdcpf_le_featurewise_feature_weights = get_array_float(value);
    } else if (MATCH("", "hdcpf_le_featurewise_enable_dynamic_weight")) {
        knob::hdcpf_le_featurewise_enable_dynamic_weight = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_weight_gradient")) {
        knob::hdcpf_le_featurewise_weight_gradient = atof(value);
    } else if (MATCH("", "hdcpf_le_featurewise_disable_adjust_weight_all_features_align")) {
        knob::hdcpf_le_featurewise_disable_adjust_weight_all_features_align = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_selective_update")) {
        knob::hdcpf_le_featurewise_selective_update = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_pooling_type")) {
        knob::hdcpf_le_featurewise_pooling_type = atoi(value);
    } else if (MATCH("", "hdcpf_le_featurewise_enable_dyn_action_fallback")) {
        knob::hdcpf_le_featurewise_enable_dyn_action_fallback = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_bw_acc_check_level")) {
        knob::hdcpf_le_featurewise_bw_acc_check_level = atoi(value);
    } else if (MATCH("", "hdcpf_le_featurewise_acc_thresh")) {
        knob::hdcpf_le_featurewise_acc_thresh = atoi(value);
    } else if (MATCH("", "hdcpf_le_featurewise_enable_trace")) {
        knob::hdcpf_le_featurewise_enable_trace = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_trace_feature_type")) {
        knob::hdcpf_le_featurewise_trace_feature_type = atoi(value);
    } else if (MATCH("", "hdcpf_le_featurewise_trace_feature")) {
        knob::hdcpf_le_featurewise_trace_feature = string(value);
    } else if (MATCH("", "hdcpf_le_featurewise_trace_interval")) {
        knob::hdcpf_le_featurewise_trace_interval = atoi(value);
    } else if (MATCH("", "hdcpf_le_featurewise_trace_record_count")) {
        knob::hdcpf_le_featurewise_trace_record_count = atoi(value);
    } else if (MATCH("", "hdcpf_le_featurewise_trace_file_name")) {
        knob::hdcpf_le_featurewise_trace_file_name = string(value);
    } else if (MATCH("", "hdcpf_le_featurewise_enable_score_plot")) {
        knob::hdcpf_le_featurewise_enable_score_plot = !strcmp(value, "true") ? true : false;
    } else if (MATCH("", "hdcpf_le_featurewise_plot_actions")) {
        knob::hdcpf_le_featurewise_plot_actions = get_array_int(value);
    } else if (MATCH("", "hdcpf_le_featurewise_plot_file_name")) {
        knob::hdcpf_le_featurewise_plot_file_name = string(value);
    } else if (MATCH("", "hdcpf_le_featurewise_remove_plot_script")) {
        knob::hdcpf_le_featurewise_remove_plot_script = !strcmp(value, "true") ? true : false;
    } else {
